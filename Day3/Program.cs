...
namespace MethodsDemo
{
    ...
    public class Program
    {
        static void Main()
        {
            ...
            Console.WriteLine($"Add(2, 3) = {demo.Add(2, 3)}");
            Console.WriteLine($"Subtract(2, 3) = {demo.Subtract(2, 3)}");
            Console.WriteLine($"Multiply(2, 3) = {demo.Multiply(2, 3)}");
            
            Console.WriteLine("\n--- Extension Method Demo ---");
            ExtnsionMethodDemo(null);
